        ...
        <div className='pt-12 md:pt-20'>
          ...
          <div className='max-w-3xl mx-auto text-center pb-12 md:pb-16'>
            <h1 className='h3 mb-4 text-blue-500'>
              <Balancer>
                Labyrinth attendees have successfully exited large companies, across a wide array of niches.
              </Balancer>
            </h1>
            <p className='text-xl text-blue-500 font-montreal'>
              Some sold high-growth tech startups, others service businesses. But all our members seek belonging,
              support, and connection with a selective group of their peers.
            </p>
          </div>
        </div>
      </div>
