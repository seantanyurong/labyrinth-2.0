      ...
      <div className='max-w-6xl mx-auto px-4 sm:px-6'>
        ...
        <div className='pt-32 pb-12 md:pt-52 md:pb-32'>
          ...
          <div className='text-center pb-12 md:pb-16'>
            <h1 className='text-3xl md:text-6xl font-extrabold mb-4 text-white' data-aos='zoom-y-out'>
              Think you're a fit?
            </h1>
            <div className='max-w-3xl mx-auto'>
              <p className='text-xl text-white mb-8 font-montreal' data-aos='zoom-y-out' data-aos-delay='150'>
                Let's find out.
              </p>
              <div
